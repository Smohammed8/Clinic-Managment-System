...
class ReligionControllerTest extends TestCase
{
     ...
     * @test
     */
    public function it_displays_index_view_with_religions(): void
    {
     ...
     * @test
     */
    public function it_displays_create_view_for_religion(): void
    {
     ...
     * @test
     */
    public function it_stores_the_religion(): void
    {
        ...
        $this->assertDatabaseHas('religion', $data);
     ...
     * @test
     */
    public function it_displays_show_view_for_religion(): void
    {
     ...
     * @test
     */
    public function it_displays_edit_view_for_religion(): void
    {
        $religion = Religion::factory()->create();
    ...
    public function it_updates_the_religion(): void
    {
        ...
        $data = [
            'religion_name' => $this->faker->text(255),
        ];
     ...
     * @test
     */
    public function it_deletes_the_religion(): void
    {
        $religion = Religion::factory()->create();
