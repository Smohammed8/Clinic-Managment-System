...
class ClinicUserLabTestRequests2Detail extends Component
{
    use WithPagination;
    ...
    public function newLabTestRequest(): void
    {
        ...
        $this->modalTitle = trans(
            'crud.clinic_user_lab_test_requests2.new_title'
        );
        $this->resetLabTestRequestData();
    ...
    public function editLabTestRequest(LabTestRequest $labTestRequest): void
    {
        $this->editing = true;
        $this->modalTitle = trans(
            'crud.clinic_user_lab_test_requests2.edit_title'
        );
    ...
    public function save(): void
    {
        ...
        if (!$this->labTestRequest->sample_analyzed_by_id) {
            $this->authorize('create', LabTestRequest::class);

            $this->labTestRequest->sample_analyzed_by_id=
                $this->clinicUser->id;
        } else {
    ...
    {
        return view('livewire.clinic-user-lab-test-requests2-detail', [
