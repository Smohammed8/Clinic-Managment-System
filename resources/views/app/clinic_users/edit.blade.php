...
<div class="">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">
                <a href="{{ route('clinic-users.index') }}" class="mr-4"
            ...
            <x-form
                method="PUT"
                action="{{ route('clinic-users.update', $clinicUser) }}"
                class="mt-4"
            >
                ...
                <div class="mt-4">
                    ...
                    <a
                        href="{{ route('clinic-users.create') }}"
                        class="btn btn-light"
                    >
    ...
    <div class="card mt-4">
        <div class="card-body">
            ...
            <livewire:clinic-user-lab-test-requests2-detail
    ...
    <div class="card mt-4">
        <div class="card-body">
            ...
            <livewire:clinic-user-main-diagnoses-detail
                :clinicUser="$clinicUser"
            />
        </div>
    </div>
    ...
    <div class="card mt-4">
        <div class="card-body">
            ...
            <livewire:clinic-user-vital-signs-detail
                :clinicUser="$clinicUser"
            />
        </div>
    </div>
    ...
    <div class="card mt-4">
        <div class="card-body">
            ...
            <livewire:clinic-user-medical-records-detail
                :clinicUser="$clinicUser"
            />
        </div>
    </div>
    ...
    <div class="card mt-4">
        <div class="card-body">
            ...
            <livewire:clinic-user-lab-test-request-groups-detail
                :clinicUser="$clinicUser"
            />
        </div>
    </div>
    ...
    <div class="card mt-4">
        <div class="card-body">
            ...
            <livewire:clinic-user-lab-test-requests-detail
                :clinicUser="$clinicUser"
            />
        </div>
    </div>
    ...
    <div class="card mt-4">
        <div class="card-body">
            ...
            <livewire:clinic-user-lab-test-requests3-detail
                :clinicUser="$clinicUser"
            />
        </div>
    </div>
    @endcan @can('view-any', App\Models\clinic_user_room::class)
    <div class="card mt-4">
        <div class="card-body">
    ...
    @endcan @can('view-any', App\Models\clinic_clinic_user::class)
    <div class="card mt-4">
        <div class="card-body">
