        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover">
                    ...
                    <tbody>
                        @forelse($clinicUsers as $clinicUser)
                        <tr>
                            <td>
                            ...
                            <td class="text-center" style="width: 134px;">
                                ...
                                >
                                    ...
                                    <a
                                        href="{{ route('clinic-users.edit', $clinicUser) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    <a
                                        href="{{ route('clinic-users.show', $clinicUser) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    <form
                                        action="{{ route('clinic-users.destroy', $clinicUser) }}"
                                        method="POST"
