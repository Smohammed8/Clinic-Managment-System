                        ...
                        <tr>
                            ...
                            <td class="text-center" style="width: 134px;">
                                ...
                                >
                                    ...
                                    <a
                                        href="{{ route('all-clinic-services.edit', $clinicServices) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    <a
                                        href="{{ route('all-clinic-services.show', $clinicServices) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    <form
                                        action="{{ route('all-clinic-services.destroy', $clinicServices) }}"
                                        method="POST"
