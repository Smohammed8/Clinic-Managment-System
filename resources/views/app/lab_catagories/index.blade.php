                ...
                <table class="table table-hover table-condensed">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> {{ $key + 1}}<td>{{ $labCatagory->lab_name ?? '-' }}</td>
                            ...
                            <td class="text-center" style="width: 134px;">
                                ...
                                >
                                    ...
                                    <a
                                        href="{{ route('lab-catagories.edit', $labCatagory) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    @endcan @can('view', $labCatagory)
                                    <a
                                        href="{{ route('lab-catagories.show', $labCatagory) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    @endcan @can('delete', $labCatagory)
                                    <form
                                        action="{{ route('lab-catagories.destroy', $labCatagory) }}"
                                        method="POST"
