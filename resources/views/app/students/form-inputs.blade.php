...
<div class="row">
    <x-inputs.group class="col-sm-12">
        <x-inputs.text name="first_name" label="First Name" :value="old('first_name', $editing ? $student->first_name : '')" maxlength="255" placeholder="First Name">
        </x-inputs.text>
    </x-inputs.group>

    <x-inputs.group class="col-sm-12">
        <x-inputs.text name="middle_name" label="Middle Name" :value="old('middle_name', $editing ? $student->middle_name : '')" maxlength="255" placeholder="Middle Name">
        </x-inputs.text>
    </x-inputs.group>

    <x-inputs.group class="col-sm-12">
        <x-inputs.text name="last_name" label="Last Name" :value="old('last_name', $editing ? $student->last_name : '')" maxlength="255" placeholder="Last Name">
        </x-inputs.text>
    </x-inputs.group>
    ...
    <x-inputs.group class="col-sm-12">
        <div x-data="imageViewer('{{ $editing && $student->photo ? \Storage::url($student->photo) : '' }}')">
    ...
    <x-inputs.group class="col-sm-12">
        <x-inputs.text name="id_number" label="Id Number" :value="old('id_number', $editing ? $student->id_number : '')" maxlength="255" placeholder="Id Number">
        </x-inputs.text>
    </x-inputs.group>
    {{-- 
    <x-inputs.group class="col-sm-12">
