        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover">
                    ...
                    <tbody>
                        @forelse($labTestRequestGroups as $labTestRequestGroup)
                        <tr>
                            ...
                            <td class="text-center" style="width: 134px;">
                                ...
                                >
                                    ...
                                    <a
                                        href="{{ route('lab-test-request-groups.edit', $labTestRequestGroup) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    <a
                                        href="{{ route('lab-test-request-groups.show', $labTestRequestGroup) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
