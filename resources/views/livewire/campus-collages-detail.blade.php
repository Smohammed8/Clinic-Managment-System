            ...
            <div class="modal-body">
                <div>
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.text name="collage.name" label="Name" wire:model="collage.name" maxlength="255"
                            placeholder="Name"></x-inputs.text>
                    </x-inputs.group>

                    <x-inputs.group class="col-sm-12">
                        <x-inputs.textarea name="collage.description" label="Description"
                            wire:model="collage.description" maxlength="255"></x-inputs.textarea>
                    </x-inputs.group>
                </div>
            </div>
            ...
            <tbody class="text-gray-600">
                @foreach ($collages as $collage)
                    <tr class="hover:bg-gray-100">
                        <td class="text-left">
                            <input type="checkbox" value="{{ $collage->id }}" wire:model="selected" />
                        </td>
