        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    ...
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.text
                            name="item.campany_name"
                            label="Campany Name"
                            wire:model="item.campany_name"
                            maxlength="255"
                    ...
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.number
                            name="item.number_of_units"
                            label="Number Of Units"
                            wire:model="item.number_of_units"
                            max="255"
                            step="0.01"
                    ...
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.number
                            name="item.number_of_unit_per_pack"
                            label="Number Of Unit Per Pack"
                            wire:model="item.number_of_unit_per_pack"
                            max="255"
                            step="0.01"
                            placeholder="Number Of Unit Per Pack"
                        ></x-inputs.number>
                    </x-inputs.group>
                    ...
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.number
                            name="item.price_per_unit"
                            label="Price Per Unit"
                            wire:model="item.price_per_unit"
                            max="255"
                            step="0.01"
                    ...
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.number
                            name="item.profit_margit"
                            label="Profit Margit"
                            wire:model="item.profit_margit"
                            max="255"
                            step="0.01"
                            placeholder="Profit Margit"
                        ></x-inputs.number>
                    </x-inputs.group>
                </div>
            </div>
