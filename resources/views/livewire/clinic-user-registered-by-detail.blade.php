<div>
    ...
    <x-modal id="clinic-user-registered-by-modal" wire:model="showingModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    ...
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.select
                            name="encounter.doctor_id"
                            label="Doctor"
                            wire:model="encounter.doctor_id"
                        >
        ...
        <table class="table table-borderless table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.clinic_user_registered_by.inputs.check_in_time')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_registered_by.inputs.status')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_registered_by.inputs.closed_at')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_registered_by.inputs.priority')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_registered_by.inputs.clinic_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_registered_by.inputs.doctor_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
