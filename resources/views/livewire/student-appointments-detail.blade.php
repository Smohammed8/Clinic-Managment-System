<div>
    ...
    <x-modal id="student-appointments-modal" wire:model="showingModal">
            ...
            <div class="modal-body">
                <div>
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.datetime
                            name="appointment.a_date"
                            label="A Date"
                            wire:model="appointment.a_date"
                            max="255"
                        ></x-inputs.datetime>
                    </x-inputs.group>
                    ...
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.select
                            name="appointment.encounter_id"
                            label="Encounter"
                            wire:model="appointment.encounter_id"
                        >
                    ...
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.select
                            name="appointment.clinic_user_id"
                            label="Doctor"
        ...
        <table class="table table-hover table-condensed">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.student_appointments.inputs.a_date')
                    </th>
                    <th class="text-left">
                        @lang('crud.student_appointments.inputs.reason')
                    </th>
                    <th class="text-left">
                        @lang('crud.student_appointments.inputs.status')
                    </th>
                    <th class="text-left">
                        @lang('crud.student_appointments.inputs.encounter_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.student_appointments.inputs.clinic_user_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
