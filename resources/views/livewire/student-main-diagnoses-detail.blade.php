<div>
    ...
    <x-modal id="student-main-diagnoses-modal" wire:model="showingModal">
        ...
        <table class="table table-borderless table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.student_main_diagnoses.inputs.clinic_user_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.student_main_diagnoses.inputs.encounter_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.student_main_diagnoses.inputs.diagnosis_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
