<div>
    ...
    <x-modal id="diagnosis-main-diagnoses-modal" wire:model="showingModal">
        ...
        <table class="table table-hover table-condensed">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.diagnosis_main_diagnoses.inputs.student_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.diagnosis_main_diagnoses.inputs.encounter_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
