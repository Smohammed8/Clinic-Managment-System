<div>
    ...
    <x-modal id="clinic-user-lab-test-requests3-modal" wire:model="showingModal">
        ...
        <table class="table table-hover table-condensed">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests3.inputs.sample_collected_at')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests3.inputs.sample_analyzed_at')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests3.inputs.status')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests3.inputs.notification')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests3.inputs.note')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests3.inputs.result')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests3.inputs.comment')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests3.inputs.analyser_result')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests3.inputs.approved_at')
                    </th>
                    <th class="text-right">
                        @lang('crud.clinic_user_lab_test_requests3.inputs.price')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests3.inputs.sample_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests3.inputs.ordered_on')
                    </th>
                    <th class="text-left">
