<div>
    ...
    <x-modal id="student-vital-signs-modal" wire:model="showingModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    ...
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.select name="vitalSign.encounter_id" label="Encounter"
        ...
        <table class="table table-hover table-condensed">
            <thead>
                <tr>
                    ...
                    <th class="text-right">
                        @lang('crud.student_vital_signs.inputs.pulse_rate')
                    </th>
                    <th class="text-right">
                        @lang('crud.student_vital_signs.inputs.rr')
                    </th>
                    <th class="text-right">
                        @lang('crud.student_vital_signs.inputs.weight')
                    </th>
                    <th class="text-right">
                        @lang('crud.student_vital_signs.inputs.height')
                    </th>
                    <th class="text-right">
                        @lang('crud.student_vital_signs.inputs.muac')
                    </th>
                    <th class="text-left">
                        @lang('crud.student_vital_signs.inputs.encounter_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.student_vital_signs.inputs.clinic_user_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
