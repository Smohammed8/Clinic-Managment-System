<div>
    ...
    <x-modal id="clinic-user-lab-test-requests2-modal" wire:model="showingModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    ...
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.select name="labTestRequest.lab_catagory_id" label="Lab Catagory"
        ...
        <table class="table table-hover table-condensed">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests2.inputs.sample_collected_at')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests2.inputs.sample_analyzed_at')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests2.inputs.status')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests2.inputs.notification')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests2.inputs.note')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests2.inputs.result')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests2.inputs.comment')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests2.inputs.analyser_result')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests2.inputs.approved_at')
                    </th>
                    <th class="text-right">
                        @lang('crud.clinic_user_lab_test_requests2.inputs.price')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests2.inputs.sample_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests2.inputs.ordered_on')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests2.inputs.lab_test_request_group_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests2.inputs.sample_collected_by_id
                                                                                                ')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests2.inputs.lab_catagory_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests2.inputs.approved_by_id
                                                                                                ')
                    </th>
                    <th></th>
                </tr>
