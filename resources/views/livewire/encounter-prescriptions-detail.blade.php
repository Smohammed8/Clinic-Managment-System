                ...
                <div>
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.textarea
                            ...
                            label="Drug Name"
                            wire:model="prescription.drug_name"
                            maxlength="255"
                        ></x-inputs.textarea>
                    </x-inputs.group>
                    ...
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.text
                            ...
                            label="Frequency"
                            wire:model="prescription.frequency"
                            maxlength="255"
                    ...
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.text
                            ...
                            label="Duration"
                            wire:model="prescription.duration"
                            maxlength="255"
                    ...
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.textarea
                            name="prescription.other_info"
                            label="Other Info"
                            wire:model="prescription.other_info"
                            maxlength="255"
                        ></x-inputs.textarea>
                    </x-inputs.group>
                </div>
