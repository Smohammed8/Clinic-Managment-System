<div>
    ...
    <x-modal id="pharmacy-item-requests-modal" wire:model="showingModal">
            ...
            <div class="modal-body">
                <div>
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.select
                            name="itemRequest.product_id"
                            label="Product"
                            wire:model="itemRequest.product_id"
                        >
        ...
        <table class="table table-borderless table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.pharmacy_item_requests.inputs.product_id')
                    </th>
                    <th class="text-right">
                        @lang('crud.pharmacy_item_requests.inputs.amount')
                    </th>
                    <th></th>
                </tr>
            </thead>
            <tbody class="text-gray-600">
                ...
                <tr class="hover:bg-gray-100">
                    ...
                    <td class="text-left">
                        {{ optional($itemRequest->product)->name ?? '-' }}
                    </td>
                    <td class="text-right">
                        {{ $itemRequest->amount ?? '-' }}
                    </td>
