<div>
    ...
    <x-modal id="clinic-user-main-diagnoses-modal" wire:model="showingModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    ...
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.select
                            name="mainDiagnosis.diagnosis_id"
                            label="Diagnosis"
        ...
        <table class="table table-borderless table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.clinic_user_main_diagnoses.inputs.student_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_main_diagnoses.inputs.encounter_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_main_diagnoses.inputs.diagnosis_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
