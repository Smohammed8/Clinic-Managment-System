<div>
    ...
    <x-modal id="clinic-user-lab-test-requests-modal" wire:model="showingModal">
        ...
        <table class="table table-hover  table-sm table-condensed">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests.inputs.sample_collected_at')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests.inputs.sample_analyzed_at')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests.inputs.status')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests.inputs.notification')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests.inputs.note')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests.inputs.result')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests.inputs.comment')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests.inputs.analyser_result')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests.inputs.approved_at')
                    </th>
                    <th class="text-right">
                        @lang('crud.clinic_user_lab_test_requests.inputs.price')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests.inputs.sample_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests.inputs.ordered_on')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests.inputs.lab_test_request_group_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests.inputs.sample_analyzed_by_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests.inputs.lab_catagory_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.clinic_user_lab_test_requests.inputs.approved_by_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
