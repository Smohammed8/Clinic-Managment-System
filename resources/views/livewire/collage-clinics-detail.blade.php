<div>
    ...
    <x-modal id="collage-clinics-modal" wire:model="showingModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    ...
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.text
                            name="clinic.code_clinic"
                            label="Code Clinic"
                            wire:model="clinic.code_clinic"
                            maxlength="255"
                    ...
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.select
                            name="clinic.campus_id"
                            label="Campus"
                            wire:model="clinic.campus_id"
                        >
        ...
        <table class="table table-hover table-condensed">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.collage_clinics.inputs.name')
                    </th>
                    <th class="text-left">
                        @lang('crud.collage_clinics.inputs.code_clinic')
                    </th>
                    <th class="text-left">
                        @lang('crud.collage_clinics.inputs.description')
                    </th>
                    <th class="text-right">
                        @lang('crud.collage_clinics.inputs.lat')
                    </th>
                    <th class="text-right">
                        @lang('crud.collage_clinics.inputs.long')
                    </th>
                    <th class="text-left">
                        @lang('crud.collage_clinics.inputs.campus_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.collage_clinics.inputs.status')
                    </th>
                    <th class="text-left">
                        @lang('crud.collage_clinics.inputs.is_active')
                    </th>
                    <th></th>
                </tr>
            </thead>
